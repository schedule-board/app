...
class ProfilePage extends StatelessWidget {
  ...
  final TextEditingController _userNameDetailController = TextEditingController();
  final TextEditingController _userEmailDetailController = TextEditingController();
